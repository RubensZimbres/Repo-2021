...
trnset,testset = data.TabularDataset.splits(path='./', train='train.csv', validation='val.csv', format='csv', fields=data_fields)
...
print(SRC.vocab.stoi['o'])
print(SRC.vocab.itos[4])
