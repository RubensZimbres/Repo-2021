...
def train(epoch):
  net.train()
  checkpoint = torch.load('/home/theone/other_models/Cellular Automaton/results/128/model_acc_99.22_293.pth')
...
with torch.no_grad():
    model = Net(c)
    checkpoint = torch.load('/home/theone/other_models/Cellular Automaton/results/improved/model_acc_99.19_697.pth')
