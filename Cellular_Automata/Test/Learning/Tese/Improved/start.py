...
def train(epoch):
  net.train()
  #checkpoint = torch.load('/home/theone/other_models/Cellular Automaton/results/Finetune/model_107_acc_99.22.pth')
  ...
  torch.save(net.state_dict(), '/home/theone/other_models/Cellular Automaton/results/improved/model_{0}_acc{1}.pth'.format(epoch,100.*(1-loss.item())))
...
with torch.no_grad():
    model = Net(c)
    checkpoint = torch.load('/home/theone/other_models/Cellular Automaton/results/improved/model_499_acc_99.20.pth')
